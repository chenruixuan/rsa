...
/**
 * User: chenruixuan
 * Date: 2017/4/10 09:46
 * Email: www@chenruixuan.com
 */
namespace Chenruixuan\Rsa;
class Rsa{
    ...
    public static function getInstance() {
        ...
        self::$PRIVATE_KEY = file_get_contents( dirname(__FILE__).'/pem/rsa_private_key.pem');
        self::$Public_KEY = file_get_contents( dirname(__FILE__).'/pem/rsa_public_key.pem');
